...
export class PremiosService {
  ...
  private apiPremiosTipoAutor = 'https://localhost:7195/api/Premio/autor';
  ...
  getPremiosTipoAutor(): Observable<Premio[]> {
    return this.http.get<Premio[]>(this.apiPremiosTipoAutor);
  }
}